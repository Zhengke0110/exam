          ...
          <transition-group name="list" tag="div" class="space-y-4">
            ...
            >
              ...
              <template #footer>
                <div
                  v-if="exam.tips"
                  class="mt-4 mb-4 rounded-lg bg-blue-50 p-3 text-sm text-blue-700 transition-all duration-300 hover:bg-blue-100"
                >
                ...
                <div class="mt-4 text-center">
                  <button
                    class="w-full rounded-lg bg-blue-500 px-6 py-3 font-semibold text-white transition-all duration-300 hover:bg-blue-600 active:bg-blue-700"
                    @click.stop="handleStartExam(exam.examCode ?? 0)"
                  >
                    参加考试
                  </button>
                </div>
...
const handleStartExam = (examCode: number) => {
  router.push(`/join-exam/${examCode}`);
};
</script>
